...
public class Chords {
	...
	public static final ChordType MAJOR_TRIAD = SmallChordType.MAJOR_TRIAD;
	/** First inversion of a major triad, for example [E, G, C]. */
	public static final ChordType MAJOR_TRIAD_6 = SmallChordType.MAJOR_TRIAD_6;
	/** Second inversion of a major triad, for example [G, C, E]. */
	public static final ChordType MAJOR_TRIAD_64 = SmallChordType.MAJOR_TRIAD_64;
	/** A minor triad, for example [C, Eb, G]. */
	public static final ChordType MINOR_TRIAD = SmallChordType.MINOR_TRIAD;
	/** First inversion of a minor triad, for example [Eb, G, C]. */
	public static final ChordType MINOR_TRIAD_6 = SmallChordType.MINOR_TRIAD_6;
	/** Second inversion of a minor triad, for example [G, C, Eb]. */
	public static final ChordType MINOR_TRIAD_64 = SmallChordType.MINOR_TRIAD_64;
	/** A diminished triad, for example [C, Eb, Gb]. */
	public static final ChordType DIMINISHED_TRIAD = SmallChordType.DIMINISHED_TRIAD;
	/** First inversion of a diminished triad, for example [Eb, Gb, C]. */
	public static final ChordType DIMINISHED_TRIAD_6 = SmallChordType.DIMINISHED_TRIAD_6;
	/** Second inversion of a diminished triad, for example [Gb, C, Eb]. */
	public static final ChordType DIMINISHED_TRIAD_64 = SmallChordType.DIMINISHED_TRIAD_64;
	...
	public static final ChordType DOMINANT_7 = SmallChordType.DOMINANT_7;
	/** A major seventh chord, for example [C, E, G, B]. */
	public static final ChordType MAJOR_7 = SmallChordType.MAJOR_7;
	/** A minor seventh chord, for example [C, Eb, G, Bb]. */
	public static final ChordType MINOR_7 = SmallChordType.MINOR_7;
	/** A minor-major seventh chord, for example [C, Eb, G, B]. */
	public static final ChordType MINOR_MAJOR_7 = SmallChordType.MINOR_MAJOR_7;
